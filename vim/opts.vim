...
set backupdir=/tmp/vim_niko/backup         " Where to put backup files
set directory=/tmp/vim_niko/swap           " Where to put swap files
let g:SESSION_DIR='/tmp/vim_niko/sessions' " where to keep sessions
...
set undodir=/tmp/vim_niko/undo           " Where to put undo files
if finddir(&undodir) == ''
